...
class StudentsRoute {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/batch/branch`,authenticateMiddleware.authorize, this.studentController.totalStudents)

        // get batchwise total vacanct seats
        this.router.get(`${this.path}/vacancy/:batchId`,authenticateMiddleware.authorize, this.studentController.studentsVacancy)
        
        //get Absent student lists for given batch, branch, semester and date values.
        this.router.get(`${this.path}/absent`,authenticateMiddleware.authorize, this.studentController.absentStudents)
        
        //get list of students whose attendance is less than 75% for given branch,batch and semester
        this.router.get(`${this.path}/attendance`,authenticateMiddleware.authorize, this.studentController.attendanceStudents)
    }
}
